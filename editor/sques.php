...
<head>
  ...
  <?php if(empty( $_GET['page_name'])) $link = 'sques' ?>
  ...
  for ($i=0; $i < $ilimit ; $i++) { 
    ...
    $ans=$_POST['ans'.$i]; 
      ...
      $sql = "UPDATE sques SET `classid` = '$classid',`subjectid` = '$subjectid',`chapterid` = '$chapterid',`ques` = '$ques',`ans` = '$ans' WHERE `id` =$id";
  ...
  for ($i=0; $i < $ilimit ; $i++) { 
    ...
    if(isset($_POST['delcat'.$i])){
      ...
      $sql = "DELETE FROM sques WHERE id=$id ";
  ...
  if(isset($_POST['addcat'])){
   ...
   $data=mysqli_query($con,"INSERT INTO sques (classid,subjectid,chapterid,ques,ans)VALUES ('$classid','$subjectid','$chapterid','$ques','$ans')")or die( mysqli_error($con) );
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix" style="padding:10px">
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-images"></i> Short Questions
            </div>
          ...
          <table class="table "  id="example" >
              ...
              <tbody>
                ...
                $rows =mysqli_query($con,"SELECT * FROM sques  ORDER BY id" ) or die(mysqli_error($con));
                $n=0;
...
<?php } ?>
                                  ...
                                  <tr>
                                    ...
                                    <td  style="">
                                      <textarea name="newans" class="form-control"> </textarea>
                                    </td>

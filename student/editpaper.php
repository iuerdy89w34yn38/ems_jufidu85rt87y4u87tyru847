          ...
          <div class="col-lg-10">
              ...
              <div class="heading" style="text-transform: capitalize;">
                <i class="fa fa-images"></i> Edit Paper
                  ...
                  <span style="float: right; margin-right: 120px">
                                      <a class="btn btn-primary" href="newpaper"> <i class="fa fa-list"></i> All Paper</a>
                                    </span>
              </div>
              <div class="widget-content padded clearfix">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                 ...
                 ?>
                  ...
                  <span style="float: right; margin-right: 120px">
                                      Total: <span id="total"> <?php echo $total ?></span>  Marks
                                    </span>
            ...
            <tr>
              ...
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="am" value="<?php echo $am ?>">
              </td>
              <td>
                Marks Per MCQ:
              </td>
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="mm" value="<?php echo $mm ?>">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="as" value="<?php echo $as ?>">
              </td>
              <td>
                Marks Per Short:
              </td>
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="ms" value="<?php echo $ms ?>">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="al" value="<?php echo $al ?>">
              </td>
              <td>
                Marks Per Short:
              </td>
              <td>
                ...
                <input onkeyup="ctotal()" onchange="ctotal()" type="number" class="form-control" name="ml" value="<?php echo $ml ?>">
              </td>
            </tr>

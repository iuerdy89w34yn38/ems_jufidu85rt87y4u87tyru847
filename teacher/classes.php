...
<head>
  ...
  <?php if(empty( $_GET['page_name'])) $link = 'classes' ?>
  ...
  if(isset($_POST['addcat'])){
   ...
   $data=mysqli_query($con,"INSERT INTO classes (name,ordr)VALUES ('$name','$ordr')")or die( mysqli_error($con) );
        ...
        <div class="col-lg-10">
          <div class="widget-container fluid-height clearfix">
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-images"></i> Classes
            </div>
            <div class="widget-content padded clearfix">
              ...
              <tbody>
                ...
                $rows =mysqli_query($con,"SELECT * FROM classes  ORDER BY ordr" ) or die(mysqli_error($con));
                $n=0;
